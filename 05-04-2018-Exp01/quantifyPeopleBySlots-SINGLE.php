...
$filename = "ranking-SINGLE-SLOTS.csv";
$logFilename = "quantify-SINGLE-SLOTS-1M-E{$acEntrada}-S{$acSaida}.log";
...
$fp = fopen("events-SINGLE-SLOTS-1M-E{$acEntrada}-S{$acSaida}.csv", 'w');
...
$fpq = fopen("quantify-SINGLE-SLOTS-1M-E{$acEntrada}-S{$acSaida}.csv", 'w');
for ($s=1; $s<=103 ; $s++) { 
